...
import kotlinx.android.synthetic.main.activity_lectures_subjects.*
...
import xyz.computingabc.ibmsprotal.Student.Lectures.Model.StudentSubjectsAdopter

class LecturesSubjects : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_lectures_subjects)
        toolbarSupport()
        fatchClasses()
